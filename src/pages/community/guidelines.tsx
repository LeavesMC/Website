  ...
  <>
    ...
    <section id="overview" className="px-4 py-4 max-w-7xl mx-auto leading-7">
      ...
      <p>
        ...
        negativity and toxicity in the LeavesMC community. We want LeavesMC to be
    ...
    >
      ...
      <ol className="list-decimal list-inside my-4 ml-4 space-y-2 py-1">
        ...
        <li>
          ...
          <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
            ...
            <li>
              Anyone with a role is a target for pinging, and the larger Leaves
      ...
      <p>
        If someone is violating those feel free to use the <code>@Leaves Team</code>{" "}
        ping on Discord to notify the LeavesMC team.
      </p>
    </section>
    <section
    ...
    >
      ...
      <p>
        ...
        don&apos;t want associated with LeavesMC in any way. These behaviors will
    ...
    >
      ...
      <p>
        Our support channels <code>#support</code>,{" "}is there
